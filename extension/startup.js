(() => {
  ...
  function release(){if(released)return;released=true;clearTimeout(timer);observer?.disconnect();style.remove();const EventType=document.defaultView?.Event;if(EventType)document.dispatchEvent(new EventType('pagepure-rules-applied'));}
  ...
  globalThis.JevStartup={prepare,release,get released(){return released;}};
})();
